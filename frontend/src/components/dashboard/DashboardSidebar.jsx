    ...
    return (
        <>
            ...
            <div className={`fixed top-0 left-0 h-full w-64 bg-white dark:bg-gray-800 shadow-xl z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="flex items-center justify-left p-4 border-b border-gray-200 dark:border-gray-700 h-16">
                    <button onClick={onClose} className="p-2 mr-6 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
