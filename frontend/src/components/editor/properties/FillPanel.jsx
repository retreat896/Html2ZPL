...
export default function FillPanel() {
    ...
    if (templateObjects.length === 0) {
        return (
            <div className="p-4 text-sm text-gray-500 text-center">
                ...
                <p className="text-xs">
                    Switch to <strong>Design Mode</strong> to add templated objects.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="p-4 space-y-4">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-200 uppercase tracking-wide mb-3">Fill Template</h3>
            ...
            {templateObjects.map((obj) => {
                ...
                return (
                    <div key={obj.id} className="space-y-1">
                        ...
                        />
                        {obj.finalInput && <p className="text-[10px] text-gray-400 truncate">Pattern: {obj.finalInput}</p>}
                    </div>
                );
            })}
        </div>
