                ...
                {isSidebarOpen && (
                    <>
                        <div className="flex items-center gap-2">
                            ...
                            {/* Mode Toggle - Only visible for Templates */}
                            {project?.metadata?.isTemplate && (
                                <div className="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1 ml-2">
                                    <button
                                        onClick={() => interactionMode !== 'design' && toggleInteractionMode()}
                                        className={clsx(
                                            'px-3 py-1 rounded text-xs font-medium transition-all',
                                            interactionMode === 'design' ? 'bg-white dark:bg-gray-600 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200',
                                        )}>
                                        Design
                                    </button>
                                    <button
                                        onClick={() => interactionMode !== 'fill' && toggleInteractionMode()}
                                        className={clsx(
                                            'px-3 py-1 rounded text-xs font-medium transition-all',
                                            interactionMode === 'fill' ? 'bg-white dark:bg-gray-600 text-green-600 dark:text-green-400 shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200',
                                        )}>
                                        Fill
                                    </button>
                                </div>
                ...
                {isSidebarOpen ? (
                    interactionMode === 'fill' ? (
                        ...
                        <>
                            ...
                            <CollapsiblePanel title="Label Settings" icon="fa-ruler-combined" isOpen={openPanels.labelSettings} onToggle={() => togglePanel('labelSettings')}>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            ...
                                            value={(() => {
                                                ...
                                                const match = LABEL_SIZES.find((s) => s.width === activeLabel.settings.width && s.height === activeLabel.settings.height && s.unit === activeLabel.settings.unit);
                            ...
                            <CollapsiblePanel title="Object Properties" icon="fa-cube" isOpen={openPanels.objectProperties} onToggle={() => togglePanel('objectProperties')}>
                                {!selectedObject ? (
                                    ...
                                    (() => {
                                        ...
                                        if (def && def.class && def.class.properties) {
                                            return <PropertiesRenderer object={selectedObject} onChange={handleObjectPropChange} schema={def.class.properties} />;
                                        }
                                        ...
                                        return PropertiesComponent ? <PropertiesComponent object={selectedObject} onChange={handleObjectPropChange} labelSettings={activeLabel?.settings} /> : <div className="text-sm text-gray-500">No properties for this type.</div>;
                                    })()
                                )}
                            </CollapsiblePanel>
                        </>
                    ...
                    <>
                        ...
                        <button onClick={() => togglePanel('labelSettings')} className="w-full p-3 flex items-center justify-center border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors" title="Label Settings">
                            <i className="fa-solid fa-ruler-combined text-gray-600 dark:text-gray-400"></i>
                        </button>

                        <button onClick={() => togglePanel('objectProperties')} className="w-full p-3 flex items-center justify-center border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors" title="Object Properties">
